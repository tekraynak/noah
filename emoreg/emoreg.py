...
trials = data.TrialHandler(nReps=45, method='sequential', 
...
instruction)
    ...
    # keep track of which components have finished
    rateComponents = [text1, text2, emo_rating]
...
# completed 45 repeats of 'trials'
